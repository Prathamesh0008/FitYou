      ...
      <div className="max-w-7xl mx-auto px-6 py-14">
        ...
        <div className="grid gap-12 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2 text-sm text-[#4A5568]">
              <li>
                <Link href="/program" className="hover:text-[#2B6CB0]">
                  Fityou Programme
                </Link>
              </li>
              <li>
                <Link href="/how-it-works" className="hover:text-[#2B6CB0]">
                  How our service works
                </Link>
              </li>
              <li>
                <Link href="/glp1-science" className="hover:text-[#2B6CB0]">
                  Science of GLP-1
                </Link>
              </li>
              <li>
                <Link href="/health-guide" className="hover:text-[#2B6CB0]">
                  Health Guide
                </Link>
              </li>
              <li>
                <Link href="/faq" className="hover:text-[#2B6CB0]">
                  FAQs
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2 text-sm text-[#4A5568]">
              <li>
                <Link href="/contact" className="hover:text-[#2B6CB0]">
                  Contact Us
                </Link>
              </li>
              <li>
                <Link href="/quiz" className="hover:text-[#2B6CB0]">
                  Eligibility quiz
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/pricing" className="hover:text-[#2B6CB0]">
                  Pricing
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2 text-sm text-[#4A5568]">
              <li>
                <Link href="/terms" className="hover:text-[#2B6CB0]">
                  Terms &amp; Conditions
                </Link>
              </li>
              <li>
                <Link href="/privacy" className="hover:text-[#2B6CB0]">
                  Privacy Policy
                </Link>
              </li>
              <li>
                <Link href="/safety" className="hover:text-[#2B6CB0]">
                  Safety Guidelines
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-10 border-t border-[#E2E8F0] pt-6 flex flex-col md:flex-row items-center justify-between">
          ...
          <Link
            href="/quiz"
            className="mt-4 md:mt-0 rounded-full bg-[#2B6CB0] px-6 py-2 text-xs font-semibold text-white shadow-sm hover:bg-[#245A96] transition"
          >
            Do I qualify?
          </Link>
        </div>
