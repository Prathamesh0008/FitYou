...
export default function HomePage() {
  return (
    <div className="min-h-screen transition-colors relative overflow-hidden">
          ...
          <div className="relative mx-auto max-w-md rounded-3xl bg-white p-5 shadow-xl border border-slate-200 dark:border-slate-800 dark:bg-slate-900">
            ...
            <div className="mt-4 rounded-2xl border border-slate-200 bg-slate-50/80 p-3 text-[11px] text-slate-700 dark:border-slate-700 dark:bg-slate-900/80 dark:text-slate-300">
              ...
              <div className="mt-2 flex h-16 items-end gap-2">
                {readinessTrends.map((item, idx) => (
                  <div key={item.label} className="flex-1">
                    <div className="relative h-12 w-full overflow-hidden rounded-full bg-slate-200/70 dark:bg-slate-800">
                      <div
                        style={{ height: `${item.value}%` }}
                        className="absolute bottom-0 left-0 w-full rounded-full bg-gradient-to-t from-sky-500 to-indigo-500 animate-pulse [animation-duration:2.5s] [animation-delay:calc(0.12s*var(--i))]"
                      />
                    </div>
      ...
      {/* WEIGHT LOSS CALCULATOR – UPDATED WITH WEIGHT DROPDOWN */}



{/* WHY OUR PROGRAM WORKS (FITYOU STYLE) */}
{/* WHY OUR PROGRAM WORKS (THEME SMART VERSION) */}
<section className="relative overflow-hidden py-20 transition-colors
    ...
    <div className="mt-12 grid gap-10 md:grid-cols-2">
      ...
      <div className="space-y-10">
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            <div className="rounded-xl px-4 py-2 text-sm font-semibold shadow-md 
            ...
            <p className="mt-2 text-xs italic 
              ...
              You can still enjoy the foods you love —  
              you'll feel satisfied after small amounts.
            </p>
          </div>
        </div>
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="mt-2 text-xs italic 
              text-slate-600 dark:text-slate-300">
              Our programme removes the mental pressure —  
              the routine guides you step-by-step.
            </p>
          </div>
        </div>
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="mt-2 text-xs italic 
              text-slate-600 dark:text-slate-300">
              Because it is effective. Clinical evidence supports it,  
              and the weekly plan is built for real life.
            </p>
          </div>
        </div>
      ...
      <div className="space-y-10">
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="mt-2 text-xs italic 
              text-slate-600 dark:text-slate-300">
              Light walking 30 minutes a few times a week  
              is enough to begin.
            </p>
          </div>
        </div>
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="mt-2 text-xs italic 
              text-slate-600 dark:text-slate-300">
              Our structured routine resets behaviours  
              and metabolic signals safely.
            </p>
          </div>
        </div>
  ...
  <div className="absolute inset-0 bg-gradient-to-b from-sky-50 to-white dark:from-slate-900 dark:to-slate-950">
    <svg className="absolute top-0 w-full opacity-70 dark:opacity-30" viewBox="0 0 1440 320">
      <path
        fill="#e9f3ff"
        fillOpacity="1"
  ...
  <div className="relative max-w-6xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-14 items-center">
    ...
    {/* LEFT */}
    <div className="animate-[fadeUp_0.9s_ease-out] opacity-0" style={{ animationFillMode: "forwards" }}>
      <h2 className="text-3xl md:text-4xl font-bold text-sky-900 dark:text-sky-200 leading-snug">
        A proven result of <span className="font-extrabold text-sky-900 dark:text-white">21% weight loss</span> in 16 months.
        Curious as to how much you could lose?
      </h2>

      <p className="mt-6 text-sm text-slate-600 dark:text-slate-300">Take the quiz. It’s free.</p>
    ...
    >
      {/* WEIGHT DROPDOWN */}
      <div>
        <label className="text-sm font-medium text-sky-900 dark:text-sky-200">Your current weight</label>
      ...
      {/* HEIGHT */}
      <div className="mt-4">
        <label className="text-sm font-medium text-sky-900 dark:text-sky-200">Your height</label>
      ...
      <button
        onClick={() => {
          const weight = Number(
            document.getElementById("currentWeight").value.split(" ")[0]
          );
          const feet = Number(document.getElementById("heightFeet").value.split(" ")[0]);
          const inch = Number(document.getElementById("heightInches").value.split(" ")[0]);
          ...
          document.getElementById("sixMonthsResult").innerText = sixMonths;
          document.getElementById("sixteenMonthsResult").innerText = sixteenMonths;
        }}
      ...
      <div className="mt-5 flex flex-col gap-4 text-sm">
        <div className="flex items-center justify-between">
          <span className="text-sky-900 dark:text-sky-200">Your weight in 6 months:</span>
          <span
            id="sixMonthsResult"
        ...
        <div className="flex items-center justify-between">
          <span className="text-sky-900 dark:text-sky-200">Your weight in 16 months:</span>
          <span
          ...
          <div className="mt-5 grid gap-4 md:grid-cols-[1.5fr,1fr]">
            ...
            <div className="rounded-2xl border border-slate-200 bg-white/80 p-4 text-xs text-slate-700 shadow-sm backdrop-blur-sm dark:border-slate-700 dark:bg-slate-900/80 dark:text-slate-200">
              ...
              <div className="mt-3 flex h-24 items-end gap-2">
                {readinessTrends.map((item, index) => (
                  <div key={item.label} className="flex-1">
                    <div className="relative h-16 w-full overflow-hidden rounded-xl bg-slate-100 dark:bg-slate-800">
                      <div
                        style={{ height: `${item.value}%` }}
                        className="absolute bottom-0 left-0 w-full rounded-xl bg-gradient-to-t from-sky-500 to-emerald-400 animate-pulse [animation-duration:2.4s]"
                      />
                    </div>
...
<section className="relative overflow-hidden py-24">
  ...
  <div className="absolute inset-0 bg-gradient-to-b from-sky-50 to-white 
    ...
    <svg className="absolute top-0 w-full opacity-70 dark:opacity-30"
      viewBox="0 0 1440 320">
      <path
        fill="#e9f3ff"
  ...
  <div className="relative max-w-6xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-14 items-center">
    ...
    {/* LEFT – ANIMATED GRAPH */}
    <div className="flex justify-center animate-[fadeUp_1s_ease-out] opacity-0"
      style={{ animationFillMode: "forwards" }}>
      ...
      <div className="relative">
        ...
        <svg width="260" height="400" viewBox="0 0 260 380">
          ...
          <rect x="0" y="0" width="260" height="380"
            className="fill-white/60 dark:fill-slate-900/40 backdrop-blur rounded-xl"
          />

          {/* ◎ Faded vertical lines */}
          <line x1="90" y1="40" x2="90" y2="340"
            stroke="#e8f0f8" strokeWidth="2" className="opacity-50 dark:opacity-20" />
          <line x1="170" y1="40" x2="170" y2="340"
            stroke="#e8f0f8" strokeWidth="2" className="opacity-50 dark:opacity-20" />

          {/* ★ ORANGE CURVE — ANIMATED DRAW */}
          <path
            d="M20 80 C 80 140, 140 180, 220 240"
            stroke="#edc7a6"
            strokeWidth="3"
            fill="none"
            className="animate-drawSlow"
          />

          {/* ★ BLUE CURVE — ANIMATED DRAW */}
          <path
            d="M20 80 C 60 200, 120 260, 220 310"
            stroke="#0d4f8b"
            strokeWidth="4"
            fill="none"
            className="animate-drawFast"
          />

          {/* ★ Data points — animated pulse */}
          <circle cx="20" cy="80" r="5"
            className="fill-[#0d4f8b] animate-pulseSlow" />
          <circle cx="120" cy="220" r="5"
            className="fill-[#0d4f8b] animate-pulseSlow delay-[300ms]" />
          <circle cx="220" cy="310" r="5"
            className="fill-[#0d4f8b] animate-pulseSlow delay-[600ms]" />

          {/* Bottom labels */}
          <text x="10" y="360" fontSize="12" fill="#60738c">Day 1</text>
          <text x="95" y="360" fontSize="12" fill="#60738c">Month 6</text>
          <text x="185" y="360" fontSize="12" fill="#60738c">Month 16</text>
        </svg>

        {/* TOP LABEL */}
        <div className="absolute left-[75px] top-[115px] w-44 px-3 py-2 
            bg-[#0d4f8b] text-white text-xs font-bold rounded-md shadow-lg
            animate-[fadeUp_1s_ease-out_0.6s] opacity-0"
          style={{ animationFillMode: "forwards" }}>
        ...
        {/* BOTTOM LABEL */}
        <div className="absolute left-[90px] top-[260px] w-44 px-3 py-2 
            bg-[#0d4f8b] text-white text-xs font-bold rounded-md shadow-lg
            animate-[fadeUp_1s_ease-out_0.9s] opacity-0"
          style={{ animationFillMode: "forwards" }}>
    ...
    {/* RIGHT – TEXT CONTENT */}
    <div className="animate-[fadeUp_1.2s_ease-out] opacity-0"
      style={{ animationFillMode: "forwards" }}>

      <h2 className="text-3xl md:text-4xl font-bold text-sky-900 dark:text-white leading-snug">
        Clinical trials show that with<br />
        our approach, you lose<br />

        <span className="relative inline-block">
          <span className="relative z-10 text-sky-900 dark:text-white font-extrabold">
            5 times more weight
          </span>
          <span className="absolute bottom-1 left-0 w-full h-2 bg-orange-200
              dark:bg-orange-500/40 -z-0 rounded-full"></span>
        </span>
      ...
      <p className="mt-4 text-sm text-slate-600 dark:text-slate-400 max-w-md">
        Published clinical trial (2022): 2,539 adults over 72 weeks, comparing our programme vs placebo.
      </p>
    </div>
  </div>
  ...
  `}</style>
      ...
      <section className="mx-auto max-w-6xl px-4 pb-20">
        <div className="grid gap-6 md:grid-cols-3">
          {[
            { title: "Daily readiness", text: "Risk indicators based on quiz inputs." },
            { title: "Weekly targets", text: "Simple, maintainable actions." },
            { title: "Behaviour tracking", text: "Track sleep, steps, timing, routine patterns." },
          ].map((box) => (
            <div
              key={box.title}
